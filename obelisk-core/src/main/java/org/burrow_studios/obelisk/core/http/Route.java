...
public class Route {
    ...
    public static class Discord {
        public static final Route LIST_DISCORD_ACCOUNTS  = new Route(GET, "accounts/discord");
    ...
    public static class Minecraft {
        public static final Route LIST_MINECRAFT_ACCOUNTS  = new Route(GET, "accounts/minecraft");
    ...
    public static class Ticket {
        public static final Route LIST_TICKETS  = new Route(GET, "tickets");
    ...
    public static class Project {
        public static final Route LIST_PROJECTS  = new Route(GET, "projects");
