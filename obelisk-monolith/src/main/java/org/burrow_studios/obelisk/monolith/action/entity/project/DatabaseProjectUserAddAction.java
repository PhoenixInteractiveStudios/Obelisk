...
public class DatabaseProjectUserAddAction extends DatabaseAction<Void> {
    private final User user;

    public DatabaseProjectUserAddAction(@NotNull BackendProject project, @NotNull User user) {
