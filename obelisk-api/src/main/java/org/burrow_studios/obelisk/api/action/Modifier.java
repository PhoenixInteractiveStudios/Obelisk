...
public interface Modifier<T extends Turtle> {
    @NotNull Obelisk getAPI();

    @NotNull T getEntity() throws IllegalStateException;

    /** Submits this modifier to be completed asynchronously. */
    void queue();

    /** Submits this modifier and returns a {@link CompletableFuture} that will be completed  */
