...
public class CheckQuery extends QueryElement<Boolean> {
    ...
    public CheckQuery(@NotNull String id, @Nullable String title, @Nullable String description, boolean optional) {
        super(id, title, description, optional, false);
    }

    public CheckQuery(@NotNull String id, @Nullable String title, @Nullable String description, boolean optional, boolean done) {
